...
//   const [bankCurr, setBankCurr] = useState("");
...
//         rate: rate !== undefined ? rate : 0, // Default to 0 if rate is undefined
//       };
//     })
//     .sort((a, b) => b.rate - a.rate) // Sort by highest value
//     .map((bank) => ({
//       label: `${bank.bank_name} (${bank.rate})`,
//       value: bank.rate.toString(),
//     }));

//   useEffect(() => {
//     // console.log(bankCurr, "kkkkkkkkkkkkkkkkkkkkkkk");
//     // console.log(getLabelByValue(bankCurr)?.split(" "));
//     console.log(bankOptions);
//   }, [bankCurr, choice]);
//   useEffect(() => {
//     if (amount) {
//       const calcResult = parseFloat(amount) * parseFloat(bankCurr);
//       setResult(calcResult);
//     } else {
//       setResult(null); // Clear the result if amount is empty
//     }
//   }, [amount, bankCurr, choice, curr]);
...
//     const item = bankOptions.find((item) => item.value === val);
...
//               data={bankOptions}
//               name="Choose Rate"
//               defaultVal={bankOptions[0]?.label}
//               onCurrencyChange={(val) => setBankCurr(val)}
//             />
//             <TextInput
...
//             />
//             <View className="mt-3  flex items-center flex-row justify-between mx-3 gap-3">
//               <TouchableOpacity
//                 className="w-[80%] py-3 rounded-2xl"
//                 disabled={!amount}
//               >
//                 <Button
//                   title="Calculate"
...
//               //     Calculated Amount: {result.toFixed(2)}
//               //   </Text>
//               // </View>
//               <View className="flex flex-col gap-2">
//                 <View className="my-1 flex flex-row justify-start items-center gap-5 mx-2">
//                   <Image
//                     source={imageMap[getLabelByValue(bankCurr)?.split(" ")[0]]}
//                     className="h-12 w-12"
//                   />
...
//   const [banks, setBanks] = useState<DropDownBank[]>([]);
//   const [amount, setAmount] = useState("");
//   const [bankCurr, setBankCurr] = useState<string | null>(null);
//   const [result, setResult] = useState<number | null>(null);
//   const [img, setImg] = useState("");
//   const [formattedResult, setFormattedResult] = useState<string | null>(null);
...
//       };
//     })
//     .sort((a, b) => (b.value > a.value ? 1 : -1)); // Sort by bank name

//   // Update result when amount or bankCurr changes
//   useEffect(() => {
//     if (amount && bankCurr) {
//       const selectedBank = banks.find((bank) => bank.bank_name === bankCurr);
//       if (selectedBank) {
...
//         }).format(calcResult);
//         setFormattedResult(formattedResult);
//         setImg(imageMap[bankCurr.split(" ")[0]]);
//         setResult(calcResult);
//         console.log(bankCurr);
//       }
//     } else {
//       setResult(null);

//       // Clear the result if amount or bankCurr is empty
//     }
...
//               data={bankOptions}
//               name="Choose Rate"
//               defaultVal={bankOptions[0]?.value || ""}
//               onCurrencyChange={setBankCurr}
//             />
//             <TextInput
//               placeholder="Enter Amount"
